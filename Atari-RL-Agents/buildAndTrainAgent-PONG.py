...
def main():
    ...
    epsilon_fn = keras.optimizers.schedules.PolynomialDecay(
        ...
        #TO CHANGE
        decay_steps= 300000 // update_period, # <=> 1,000,000 ALE frames
    ...
    ckptdir='./lastModelCheckpoint/PONG'

    global_step = tf.Variable(0, trainable=False, name='global_step')

    checkpoint_dir = os.path.join(ckptdir, 'checkpoint')
    ...
    def train_agent(n_iterations):
        ...
        if iteration % save_period == 0 and iteration:
            ...
            #LAST
            if iteration == n_iterations or iteration == n_iterations//2:
                print('Saving Chkpt..')
